...
int _tmain()
{
    ...
    StringCchCat(pFileName,MAX_PATH,_T("OldIOCPFile.txt"));
    ...
    //将文件句柄与IOCP线程池绑定
    BindIoCompletionCallback(hTxtFile,FileIOCompletionRoutine,0);
...

{
    ...
    ST_MY_OVERLAPPED* pMyOl = CONTAINING_RECORD((LPOVERLAPPED)lpOverlapped,ST_MY_OVERLAPPED,m_ol);

...
int _tmain()
{
    ...
    //==========================================================================================================
    //在这里添加Winsock的调用
    SOCKET skClient         = socket(AF_INET,SOCK_DGRAM,IPPROTO_UDP);
    ...
    sendto(skClient,(char*)pszSendMsg,szLen*sizeof(WCHAR),0,(SOCKADDR*)&sa,isaLen);

    recvfrom(skClient,(char*)pszRecvBuf,1024*sizeof(WCHAR),0,(SOCKADDR*)&sa,&isaLen);
